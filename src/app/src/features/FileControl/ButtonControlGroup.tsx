...
const ButtonControlGroup = () => {
  ...
  return (
    <div className="flex flex-shrink-0 rounded-md bg-white dark:bg-dark shadow-md border-blue-500 border-2 overflow-hidden h-10 max-xl:h-9 portrait:h-14">
      <Button
      ...
      />
      <Divider />
      <div className="grid grid-cols-[60px_2px_60px] h-full portrait:grid-cols-[80px_2px_80px]">
        <DropdownMenu>
